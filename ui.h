...
void DrawGameHeader(
    double averageTimePerCell);      // Draw the elements from the game header
void DrawDebugCellValues(int *grid); // Shows the grid values
void DrawObjects(int *grid); // Draws the filling objects (snake, obstacles)
...
void HandleInputs(int *grid, struct Snake *snake, bool *gameOver, bool *restart,
                  bool *muted, bool *paused);
